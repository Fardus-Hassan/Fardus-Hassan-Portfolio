export const editorialExperiences = [
  {
    company: "Freelance Hub BD Ltd",
    tagline:
      "ERP and institutional software for schools & madrasahs across Bangladesh.",
    ...
    bullets: [
      "Developed multiple comprehensive ERP-based products using React.js & Redux, working closely with Django backend developers.",
  ...
  },
  {
    ...
    tagline:
      "POS, e-commerce, and business software delivered with a product-focused team.",
...
export const editorialEducation = {
