    ...
    return (
        <div className='banner xl:py-[140px] py-10 relative'>
            <div className='container flex flex-col justify-center h-full 2xl:w-[80%] xl:w-[90%] w-[95%] mx-auto'>
                <div className='flex xl:flex-row flex-col-reverse justify-between items-center md:gap-20 gap-10'>
                    <div>
                    ...
                    <div>
                        <img className='min-w-[100%] lg:h-[550px] md:h-[450px] h-[350px] object-cover duration-300 ease-out rounded-full' src="../../../public/InShot_20240703_024351363.jpg" alt="" style={{
                            transform: `translateY(${scrollPosition / -5}px)`
                        }} />
                    </div>
                </div>
            </div>
            <img className='absolute top-5 left-5 w-20' src="https://private-user-images.githubusercontent.com/155534646/345079649-2742533b-af38-4074-9739-62badd26f318.png?jwt=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJnaXRodWIuY29tIiwiYXVkIjoicmF3LmdpdGh1YnVzZXJjb250ZW50LmNvbSIsImtleSI6ImtleTUiLCJleHAiOjE3MjAwNTA3MDcsIm5iZiI6MTcyMDA1MDQwNywicGF0aCI6Ii8xNTU1MzQ2NDYvMzQ1MDc5NjQ5LTI3NDI1MzNiLWFmMzgtNDA3NC05NzM5LTYyYmFkZDI2ZjMxOC5wbmc_.nbrJSjpWgzh14SLzA4eAboaCaRk8duDs-FgTlJxOZvw" alt="" />
            <img className='absolute bottom-5 right-5 w-20' src="https://private-user-images.githubusercontent.com/155534646/345072090-d3c615d3-32ab-4f37-8eac-0e79e7ae2d0c.png?jwt=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJnaXRodWIuY29tIiwiYXVkIjoicmF3LmdpdGh1YnVzZXJjb250ZW50LmNvbSIsImtleSI6ImtleTUiLCJleHAiOjE3MjAwNTA3MDcsIm5iZiI6MTcyMDA1MDQwNywicGF0aCI6Ii8xNTU1MzQ2NDYvMzQ1MDcyMDkwLWQzYzYxNWQzLTMyYWItNGYzNy04ZWFjLTBlNzllN2FlMmQwYy5wbmc_.dBN746aeGnmdv-boS71UDgMcOLvqughUVkt1yz8cTD8" alt="" />
        </div>
    );
};
