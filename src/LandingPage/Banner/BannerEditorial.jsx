...
import { EASE_SECTION, useStaggerVariants } from "../../Components/SectionReveal";
...
const BannerEditorial = () => {
  ...
  const { container: stagger, item } = useStaggerVariants();
    ...
    >
      ...
      <div className="relative z-[3] mx-auto w-[92%] max-w-[1240px] sm:w-[90%]">
        ...
        <m.div
          ...
          transition={{ delay: 0.35, duration: 0.5, ease: EASE_SECTION }}
        >
