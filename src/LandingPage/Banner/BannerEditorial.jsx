    ...
    >
      ...
      <div className="relative z-[3] mx-auto w-[92%] max-w-[1240px] sm:w-[90%]">
        <div className="grid items-center gap-10 sm:gap-12 lg:grid-cols-12 lg:gap-14">
          ...
          <div className="order-1 space-y-5 text-center sm:space-y-6 lg:order-none lg:col-span-6 lg:space-y-6 lg:text-left">
            ...
            <div className="flex gap-3 flex-row flex-wrap items-center lg:justify-start justify-center">
              <a
                href="#projects"
          ...
          {/* Portrait */}
          <div className="group relative order-2 mx-auto w-full max-w-[420px] lg:order-none lg:col-span-5 lg:mx-0 lg:max-w-none">
            <div
          ...
          {/* Desktop social rail */}
          <div className="order-3 hidden flex-col items-center justify-center gap-6 lg:order-none lg:col-span-1 lg:flex">
        ...
        <div className="mt-10 border-t border-black/[0.08] pt-8 lg:hidden">
